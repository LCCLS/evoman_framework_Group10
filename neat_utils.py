...
def average_experiment_gens(root_dir):
    ...
    #total_mean_exp['Max Standard Deviation Lower'] = total_mean_exp['best'] + total_mean_exp['std']
    #total_mean_exp['Max Standard Deviation Lower'] = total_mean_exp['best'] - total_mean_exp['std']

    #total_mean_exp['Max Standard Deviation Lower'] = total_mean_exp['mean'] + total_mean_exp['std']
    #total_mean_exp['Max Standard Deviation Lower'] = total_mean_exp['mean'] - total_mean_exp['std']
...
def best_solution_boxplots(alg1_dir_filepath, alg2_dir_filepath, best_genomes1, best_genomes2, enemy):
    """
    ...
    genomes1 = pd.read_csv(f"{best_genomes1}/")
